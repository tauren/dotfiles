# Objectives
# - Only install clients application on main system (i.e. mongodo-compass)
...
# Image manipulation https://www.imagemagick.org/
brew 'imagemagick'
...
# Install SSH key on server https://www.ssh.com/ssh/copy-id
brew 'ssh-copy-id'
...
# Suggest previous commands https://github.com/zsh-users/zsh-autosuggestions
